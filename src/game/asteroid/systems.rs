...
fn spawn_asteroid(commands: &mut Commands,
    window: &Window,
...
pub fn asteroid_startup(mut commands: Commands, 
    window_query: Query<&Window, With<PrimaryWindow>>, 
    asset_server: Res<AssetServer>) {
    spawn_asteroid(&mut commands, window_query.get_single().unwrap(), &asset_server);
}

pub fn asteroid_spawn_over_time(mut commands: Commands, 
    window_query: Query<&Window, With<PrimaryWindow>>, 
    asset_server: Res<AssetServer>,
...
pub fn asteroid_movement(mut asteroid_query: Query<(&mut Transform, &Asteroid)>, 
    time: Res<Time>) {
...
pub fn asteroid_collision(mut commands: Commands,
...
pub fn asteroid_lifetime(mut commands: Commands,
...
pub fn asteroid_tick_spawn_timer(mut asteroid_spawn_timer: ResMut<AsteroidSpawnTimer>, time: Res<Time>)
{
